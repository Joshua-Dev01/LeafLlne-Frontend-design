  ...
  return (
    <TooltipProvider delayDuration={100}>
      <motion.aside
        ...
        className="bg-white dark:bg-[#090909] text-[#171223] dark:text-white h-full
      ...
      >
        ...
        <div className={`flex items-center mb-8 ${collapsed ? "justify-center" : "justify-between"}`}>
          <AnimatePresence initial={false}>
            {!collapsed && (
              ...
              >
                <p className="text-xl font-semibold tracking-tight text-[#4b0082] dark:text-violet-300">
                  Leafline
                </p>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  hover:bg-neutral-100 dark:hover:bg-[#1b1b1b] rounded-full transition"
                >
                  {collapsed ? (
        ...
        <div className="mt-auto pt-3 border-t border-neutral-200 dark:border-neutral-800 flex flex-col gap-1.5">
          <SidebarItem
            icon={RiSettingsLine}
            text="Settings"
            path="/settings"
          ...
          <Link
            ...
            className={`flex items-center gap-3 rounded-xl p-2 mt-2 transition hover:bg-neutral-100 dark:hover:bg-[#151515]
            ${collapsed ? "justify-center" : ""}`}
          >
            {user.pictureUrl ? (
              <Avatar src={user.pictureUrl} size={36} />
            ) : (
              <Avatar size={36} style={{ backgroundColor: "#4b0082" }}>
                {user.initials}
              </Avatar>
            )}
            <AnimatePresence initial={false}>
...
const SidebarItem = ({
  ...
  const item = (
    <motion.div
      ...
      ${
        active
          ? "bg-violet-100 text-[#150e2b] dark:bg-violet-950 dark:text-violet-200"
          : "text-neutral-500 hover:bg-neutral-100 hover:text-neutral-900 dark:text-neutral-400 dark:hover:bg-[#151515] dark:hover:text-white"
      }`}
    >
